...
install -m 644 server/zmapi.py server/porchlight_server.py build/usr/share/porchlight/server/
...
dpkg-deb --root-owner-group --build build porchlight_2.0_all.deb
echo "built porchlight_2.0_all.deb"
